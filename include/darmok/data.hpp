...
namespace darmok
{
	...
	{
	public:
        DLLEXPORT FileDataLoader(bx::FileReaderI& fileReader, const OptionalRef<bx::AllocatorI>& alloc = nullptr);
        DLLEXPORT [[nodiscard]] IDataLoader::result_type operator()(std::string_view filePath) override;
	private:
