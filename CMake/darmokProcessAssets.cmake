  ...
  foreach(ASSET_ELM ${ARGS_ASSETS})
    ...
    foreach(ASSET_PATH_ABS ${ASSET_PATHS})
      ...
      elseif(ASSET_EXT STREQUAL ".vlayout.json")
        ...
        if(EXISTS ${SKEL_CONFIG_PATH} AND NOT ASSET_PATH_ABS STREQUAL ${SKEL_CONFIG_PATH})
          list(APPEND SKELETON_ASSETS ${ASSET_PATH_ABS})
          set(FOUND ON)
        endif()
        if(EXISTS ${MODEL_CONFIG_PATH} AND NOT ASSET_PATH_ABS STREQUAL ${MODEL_CONFIG_PATH})
