...
function(darmok_compile_shader)
    ...
    foreach(SHADER_FILE ${ARGS_SHADERS})
        ...
        if(ARGS_HEADER)
            ...
            list(APPEND COMMANDS COMMAND ${CMAKE_COMMAND}  -D HEADER_INCLUDES="${GENERATOR_COMBINED_INCLUDES}" -D OUTPUT="${COMBINED_OUTPUT}" -P ${CMAKE_CURRENT_SOURCE_DIR}/CMake/genCombinedHeader.cmake)
        endif()
