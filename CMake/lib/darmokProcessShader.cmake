...
function(darmok_process_shader)
  ...
  foreach(SHADER_PATH ${ARGS_SHADERS})
    ...
    if(ARGS_HEADER)
      ...
      list(APPEND SHADER_COMMANDS COMMAND ${CMAKE_COMMAND} -D HEADER_INCLUDES="${GENERATOR_COMBINED_INCLUDES}" -D OUTPUT="${COMBINED_OUTPUT}" -P ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/generateCombinedHeader.cmake)
    endif()
